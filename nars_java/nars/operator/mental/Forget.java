 ...
 */
public class Forget extends Operator implements Mental {
     ...
     */
    float priorityDecrementFactor=0.5f;
    ...
    protected ArrayList<Task> execute(Operation operation, Term[] args, Memory memory) {
        ...
        concept.setPriority(concept.getPriority()*priorityDecrementFactor);
