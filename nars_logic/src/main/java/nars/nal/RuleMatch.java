...
public class RuleMatch extends FindSubst {
    ...
    public String toString() {
        return "RuleMatch:{" +
                ...
                //(branchPower.apply()!=null ? (", derived:" + branchPower) : "")+
                '}';
    ...
    public final void start(Premise p, Consumer<Task> receiver, Deriver d) {
        ...
        //setPower(branchPower.apply()); //HACK is this where it should be assigned?
...
//    }
    ...
    static Truth getTruth(final PostCondition outcome, final char punc, final Truth T, final Truth B) {
        ...
        BinaryOperator<Truth> f = getTruthFunction(punc, outcome);
