...
/**
 * the indicated relation term is inserted at the index location of the original
 * image used to make products from image subterms
 */
public class ImageMatch /* extends ArrayEllipsisMatch<Term> */{
	 ...
	 * 
	 * @param t
	 *            the subvector of image terms collected in the ellipsis match,
	 *            to be expanded with relationTerm inserted in the correct imdex
	 *            position
	 * @param relationTerm
	 *            the term which replaces the _ in the formed term vector
	 * @param y
	 *            the (concrete) image being matched against the pattern
	 * @return
	 */
