...
public class PatternCompound extends GenericCompound {
    ...
    public  int volCached;
    public  int structureCachedWithoutVars;
    public  Term[] termsCached;
    protected  boolean ellipsis;
    private  boolean commutative;
    private  boolean ellipsisTransform;

    public PatternCompound(GenericCompound toCopy) {
        super(toCopy);
    }
