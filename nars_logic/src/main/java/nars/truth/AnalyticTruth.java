...
//    public static AnalyticTruth apply(final float f, final float c, final Truth t) {
//        return AnalyticTruth.apply(f, c, t, (Memory)null);
//    }
//
//    /** returns null if the confidence is zero or below the memory's confidence threshold */
//    public static AnalyticTruth apply(float freq, float conf, Truth copyEpsilonFrom, Memory m) {
