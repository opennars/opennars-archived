...
//        assertEquals(Interval.interval(1, m), a11.apply(0));
//        assertEquals(Interval.interval(0), a11.apply(0));
//
...
//            long halfDuration = n.memory().duration.apply()/2;
//
//            List<AbstractInterval> ad1 = Interval.intervalSequence(halfDuration, 1, m);
//            assertEquals(1, ad1.size());
//            assertEquals(Interval.interval(1), ad1.apply(0));
...
//            long duration = n.memory().duration.apply();
//            int numTerms = 6;
